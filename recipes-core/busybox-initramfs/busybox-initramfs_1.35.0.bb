FILESEXTRAPATHS:append := ":${COREBASE}/meta/recipes-core/busybox/busybox"
FILESEXTRAPATHS:append := ":${COREBASE}/meta/recipes-core/busybox/busybox-1.31.0"
...
do_install:append() {
	...
	sed -e "s%MOUNT_OPTIONS%${SWITCH_ROOTFS_MOUNT_OPT}%g" -i ${D}/init
	rm -rf ${D}/lib
}
